...
- Include basic tool schemas (JSON), avoid complexity
- Include the system prompt outline, the agent persona matters
- Call out known gotchas from lesson.md or prior solutions
- Prefer simple architecture unless complexity is justified
- Spec the execution flow as a clear, brief sequence, not prose
