# AI Devs Course — Agent Guidelines
...
- Use `***hub_endpoint***` in docs — never hardcode URLs/endpoints
...
## Template
Copy `template/` scaffold for new tasks. Extend `package.json` as needed.
